"""Data models for Method Validator v1."""
...
class ValidationResult:
    ...
    issues: list[ValidationIssue] = dc_field(default_factory=list)
    documents: list[MethodDocument] = dc_field(default_factory=list)
    registry: dict[str, MethodDocument] = dc_field(default_factory=dict)
    ...
    def registry_available(self) -> bool:
        return self.summary.errors == 0 and bool(self.registry)
